...
export const setNoteModificationBufferWithSelectedNotesAtom = atom(null, (get, set, pointerPos: { initX: number, initY: number }) => {
...
export const setNoteModificationBufferWithAllNotesAtom = atom(null, (get, set, pointerPos: { initX: number, initY: number }) => {
  set(noteModificationBufferAtom, {
