...
import { getNoteFromEvent, getNoteFromPosition, getNoteNumFromEvent, getNoteNumFromOffsetY, getTickFromEvent, getTickFromOffsetX } from "@/helpers/conversion";
...
export default function usePianoRollMouseHandlers() {
  ...
  const getTickAndNoteNumFromEvent = (e: PointerEvent) => {
    ...
    const ticks = pianoRollStore.roundDownTickToNearestGrid(getTickFromEvent(pianoRollStore.pianoLaneScaleX, e));
